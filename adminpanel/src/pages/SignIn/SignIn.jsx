...
function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-white to-zinc-100">
      {/* Left Column */}
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-slate-200">
          ...
          <div className="text-center mb-6">
            <img
              src={LogoImage}
              alt="Logo"
              className="w-32 sm:w-40 lg:w-48 h-auto object-contain mx-auto mb-3"
            />
            <h1 className="text-xl sm:text-2xl font-extrabold bg-gradient-to-r from-gray-500 to-gray-600 bg-clip-text text-transparent">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-3 h-4 w-4 sm:h-5 sm:w-5 text-zinc-400" />
              <input
                type="email"
                name="email"
                ...
                placeholder="Email"
                className="w-full pl-10 sm:pl-12 py-2.5 sm:py-3 rounded-full border border-amber-300 bg-white focus:outline-none focus:ring-2 focus:ring-amber-100 text-sm sm:text-base"
              />
              {fieldErrors.email && (
            ...
            {/* Password */}
            <div className="relative">
              <Lock className="absolute left-3 top-3 h-4 w-4 sm:h-5 sm:w-5 text-zinc-400" />
              <input
                ...
                className="w-full pl-10 sm:pl-12 pr-10 py-2.5 sm:py-3 rounded-full border border-amber-300 bg-white focus:outline-none focus:ring-2 focus:ring-amber-100 text-sm sm:text-base"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-amber-400 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-white py-2.5 sm:py-3 rounded-full shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-50 flex items-center justify-center cursor-pointer text-sm sm:text-base"
            >
              {loading ? (
                <svg
          ...
          <div className="my-5 relative">
            <div className="flex items-center justify-center">
              ...
              <span className="mx-3 text-xs sm:text-sm text-slate-500 bg-white px-2">
                Or sign in with
              </span>
              <div className="flex-grow border-t border-slate-300"></div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={googleLogin}
              className="border border-slate-300 p-2.5 sm:p-3 rounded-full bg-white hover:border-zinc-500 flex items-center justify-center transition-colors duration-200 cursor-pointer"
            >
              <img
                src={GoogleIcon}
                alt="Google"
      ...
      {showForgotModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/10 p-4">
          <div className="relative bg-white w-full max-w-sm rounded-2xl p-5 sm:p-6 shadow-lg border border-slate-300">
            <button
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 rounded-full border border-slate-300 focus:ring-1 focus:ring-slate-600 focus:outline-none text-sm sm:text-base"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-amber-400 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-white py-2 sm:py-2.5 rounded-full shadow hover:shadow-md transition-all duration-200 cursor-pointer text-sm sm:text-base"
            >
              Send
            </button>
          </div>
