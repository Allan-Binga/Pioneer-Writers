...
const { postOrder, getOrders, getUsersOrders, updateOrder, deleteOrder, completeOrderPost } = require("../controllers/orders")
...
router.patch("/post-order/step-two", completeOrderPost)
