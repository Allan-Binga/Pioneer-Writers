...
const { postOrder, getOrders, getUsersOrders, updateOrder, deleteOrder, getSingleOrder, getAdminSingleOrder, getWritersOrders, getPublicOrderDetails, submitAssignment, completeOrder, disputeOrder, extendDeadline} = require("../controllers/orders")
...
router.post("/order/extend-deadline/:orderId", authUser, extendDeadline)
