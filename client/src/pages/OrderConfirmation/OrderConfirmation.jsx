...
function OrderConfirmation() {
  ...
  const handleSubmit = async (e, isDraft = false) => {
    ...
    try {
      ...
      if (isDraft) {
        // Clear specific localStorage items after saving draft
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <SelectField
                    ...
                    options={[
                      ...
                      { value: "select-subject", label: "Select subject" }, // If you want to keep the empty selector last, move this down
                      ...
                      {
                        value: "west-european-studies",
                        label: "West European Studies",
                      },
                    ]}
                    required
                  />
