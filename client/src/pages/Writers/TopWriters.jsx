...
function TopWriters() {
  ...
  return (
    <div className="flex-1 flex-col min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <Navbar />
      <div className="flex">
        {/* Main Content Area */}
        <main className="flex-1 transition-all duration-300  pt-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-3xl font-bold text-slate-800 mb-4 mt-8">Top Performing Writers</h1>
